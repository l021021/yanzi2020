            ...
            try {
                ...
                switch (json.messageType) {
                    ...
                    case 'SubscribeData':
                        ...
                        eventsCounter[eventObj.locationId + '_' + _Locations[eventObj.locationId] + ':' + eventObj.did + ':' + json.list[0].eventType.name] = (eventsCounter[eventObj.locationId + '_' + _Locations[eventObj.locationId] + ':' + eventObj.did + ':' + json.list[0].eventType.name] + 1) || 1
